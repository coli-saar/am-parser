...
from graph_dependency_parser.inside_maximization.AMAutomataTask import AMAutomataTask

logger = logging.getLogger(__name__)  # pylint: disable=invalid-name


@Model.register("graph_dependency_parser_automata")
class GraphDependencyParser(Model):
    ...
    def __init__(self,
        ...
        self.tasks : Dict[str, AMAutomataTask] = {t.name : t for t in tasks}
