...
class UniversalDependenciesDatasetReader(DatasetReader):
    ...
    def _read(self, file_path: str):
        ...
        with open(file_path, 'r') as conllu_file:
            ...
            for i,annotation in  enumerate(lazy_parse(conllu_file.read())):
                ...
                yield self.text_to_instance(i,words, pos_tags, list(zip(tags, heads)))
    ...
    def text_to_instance(self,  # type: ignore
        ...
        fields["metadata"] = MetadataField({"words": words, "pos": upos_tags, "position_in_corpus" : position_in_corpus})
