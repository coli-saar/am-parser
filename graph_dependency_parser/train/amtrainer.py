...
# see https://github.com/allenai/allennlp/blob/030ef755aeeee7d05d119dcfe367f81bb26aed53/allennlp/training/trainer.py
...
@TrainerBase.register("am-trainer")
class AMTrainer(TrainerBase):
    def __init__(self,
                 model: Model,
    ...
    def train(self, experiment=None, model_path=None) -> Dict[str, Any]:
        """
    ...
    def from_params(cls,  # type: ignore
                    ...
                    params: Params,
                    validation_iterator: DataIterator = None) -> 'AMTrainer':
