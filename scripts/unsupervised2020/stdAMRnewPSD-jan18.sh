...
python -u train.py jsonnets/acl2019/single/bert/PSD.jsonnet -s /local/jonasg/unsupervised2020/temp/PSDheuristicsNewPrePost-jan18/ -f --file-friendly-logging -o ' {"trainer" : {"cuda_device" :  2 }, "train_data_path": [["PSD", "/proj/irtg/sempardata/uniformify2020/new_psd_preprocessing/train/train.amconll"]], "validation_data_path": [["PSD", "/proj/irtg/sempardata/uniformify2020/new_psd_preprocessing/gold-dev/gold-corpus.amconll"]]}' --comet Yt3xk2gaFeevDwlxSNzN2VUKh --tags PSD newprepost --project unsupervised2020 &> /proj/irtg/sempardata/unsupervised2020/logs/PSDheuristicsNewPrePost-jan18.log &


# training original AMR
echo "starting AMR (orig heuristics) on GPU 3"
python -u train.py jsonnets/acl2019/single/bert/AMR-2017.jsonnet -s /local/jonasg/unsupervised2020/temp/AMRheuristics-jan18/ -f --file-friendly-logging -o ' {"trainer" : {"cuda_device" :  3 }, "train_data_path": [["AMR-2017", "/proj/irtg/sempardata/ACL2019/AMR/2017/train/train.amconll"]], "validation_data_path": [["AMR-2017", "/proj/irtg/sempardata/ACL2019/AMR/2017/gold-dev/gold-corpus.amconll"]]}' --comet Yt3xk2gaFeevDwlxSNzN2VUKh --tags ACL19redo --project unsupervised2020-amr &> /proj/irtg/sempardata/unsupervised2020/logs/AMRheuristics-jan18.log &
