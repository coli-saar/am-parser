...
from graph_dependency_parser.components.evaluation.predictors import AMconllPredictor, AMconllPredictorEnsembling
...
model.vocab.set_from_file("{}/vocabulary/DM_head_tags.txt".format(args.pretrained_dir), is_padded=False, oov_token='IGNORE', namespace='DM_head_tags')

predictor = AMconllPredictorEnsembling(dataset_reader,args.k,args.give_up, args.threads, pretrained_model=load_model, beta=0.5, model=model)
# predictor = AMconllPredictor(dataset_reader,args.k,args.give_up, args.threads, model=load_model)
