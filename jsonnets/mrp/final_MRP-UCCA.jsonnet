...
#============TASKS==============
local my_tasks = ["MRP-UCCA"];
local main_task = "MRP-UCCA"; #what validation metric to pay attention to.
#===============================
...

{
    ...
    "model": {
        ...
        "tasks" : [task_models(task_name,dataset_reader, data_iterator, final_encoder_output_dim, "kg_edges","kg_edge_loss") for task_name in my_tasks],
        ...
        "encoder": {
            ...
            "encoder": {
                ...
                "input_size": 1024 + 1024 + pos_dim + lemma_dim + ner_dim
            }
        },
        ...
        "text_field_embedder": {
            ...
            "embedder_to_indexer_map": {
                "bert": ["bert", "bert-offsets"], "elmo" : ["elmo"] },
            "token_embedders": {
                "bert" : {
                    "type": "bert-pretrained",
                        "pretrained_model" : bert_model,
