...
local test_evaluators = import '../../../../configs/my_test_evaluators.libsonnet';

local data_paths = import '../../../../configs/my_data_paths.libsonnet';

local eval_commands = import '../../../../configs/eval_commands.libsonnet';

local UD_banks = data_paths["UD_banks"];

local task_models = import '../../../../configs/my_task_models.libsonnet';
...
#============TASKS==============
local my_tasks = ["PSD"];
local main_task = "PSD"; #what validation metric to pay attention to.
#===============================
