...
local min_count_words = 7;  # 7 # in train.tsv exposure example is the only occurrence of the relevant word
...
local dev_amconll_corpus_path = path_prefix + "inputs/train100/dp_dev.amconll";  # output of PrepareDevData.java
