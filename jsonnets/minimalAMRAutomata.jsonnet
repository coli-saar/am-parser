...
local amconll_path = "example/minimalAMRAutomata/corpus.amconll";
local gold_path = "example/minimalAMRAutomata/gold.txt";
#===============================
	...
	
{
    ...
    "train_data_path": [ [my_task, train_zip_path]],
    "validation_data_path": [ [my_task, dev_zip_path]],
