...
#============TASKS==============
local my_tasks = ["AMR-2020"];
local main_task = "AMR-2020"; #what validation metric to pay attention to.
#===============================
...

{
    ...
    "model": {
        ...
        "encoder": {
            ...
            "encoder": {
                ...
                "input_size": num_filters + glove_dim + word_dim + pos_dim + lemma_dim + ner_dim
            }
        },
    ...
    "trainer": {
        ...
        "patience" : 10,
        "cuda_device": device,
        #"grad_clipping": 5.0, #IMPORTANT: NO GRADIENT CLIPPING HERE!
        "optimizer": {
            "type": "adam",
        },
