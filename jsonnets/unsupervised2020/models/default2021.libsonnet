# model parameters
local lr = 0.001; # learning rate
local pos_dim = 32; # embedding dimension for POS (part of speech) tags
local lemma_dim = 64; # embedding dimension for lemmas
local word_dim = 1024; # embedding dimension for the words themselves -- here we use a version of Bert with 1024 dimensions
local ner_dim = 16; # embedding dimension for named entity tags
local hidden_dim = 256; # hidden layer dimension for the Bi-LSTM
local hidden_dim_mlp = 1024; # dimension for the final supertagger and edge model hidden layers
local dropout = 0.3;  # dropout rate in the Bi-LSTM
local recurrent_dropout_probability = 0.4;  # dropout rate for recurrent part of decoder
local dropout_mlp = 0.4;  # dropout rate in the final supertagger and edge model hidden layers
