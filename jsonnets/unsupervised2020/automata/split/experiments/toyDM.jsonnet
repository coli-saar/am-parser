...
#============TASKS==============
local my_task = "DM";
local corpus_path = "example/DMAutomataTest/train.zip";
local dev_corpus_path = "example/DMAutomataTest/dev.zip";
local dev_amconll_corpus_path = "example/DMAutomataTest/dev.amconll";
local dev_sdp_corpus_path = "example/DMAutomataTest/mini.dm.sdp";
#===============================
