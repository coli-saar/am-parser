...

{
	...
	"evaluation_command" : {
		"type" : "bash_evaluation_command",
			...
			// In this command, you can use the literal "{system_output}" for the path to the amconll file that serves as input here (this file was generated by the parser) and "{gold_file}" as the path to the gold data.
