...
local sdp_evaluator(dataset_reader, data_iterator, name, threads, from_epoch) = {
        ...
        "formalism" : name,
        "system_input" : my_sdp_prefix+name+"/dev/dev.amconll",
        "gold_file" : my_sdp_prefix+name+"/dev/dev.sdp",
...
function (dataset_reader, data_iterator) {
  "AMR-2015" :  {
        "type": "standard_evaluator",
        "formalism" : "AMR-2015",
        "system_input" : my_prefix+"AMR/2015/dev/dev.amconll",
        "gold_file": my_prefix+"AMR/2015/dev/goldAMR.txt",
        "use_from_epoch" : 10,
        "predictor" : {
                "type" : "amconll_predictor",
                "dataset_reader" : dataset_reader, #same dataset_reader as above.
    ...
    "AMR-2017" :  {
        "type": "standard_evaluator",
        "formalism" : "AMR-2017",
        "system_input" : my_prefix+"AMR/2017/dev/dev.amconll",
        "gold_file": my_prefix+"AMR/2017/dev/goldAMR.txt",
        "use_from_epoch" : 10,
        "predictor" : {
                "type" : "amconll_predictor",
                "dataset_reader" : dataset_reader, #same dataset_reader as above.
    ...
    "EDS" :  {
        "type": "standard_evaluator",
        "formalism" : "EDS",
        "system_input" : my_prefix+"EDS/dev/dev.amconll",
        "gold_file": my_prefix+"EDS/dev/dev-gold",
        "use_from_epoch" : 10,
        "predictor" : {
                "type" : "amconll_predictor",
                "dataset_reader" : dataset_reader, #same dataset_reader as above.
