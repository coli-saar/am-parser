local validation_evaluators = import 'uniformify_validation_evaluators.libsonnet';
...
function(name,dataset_reader, data_iterator, validation_iterator, final_encoder_output_dim, edge_model, edge_loss, label_loss) {
    "name" : name,
    "dropout": 0.3,
    ...
    "edge_model" : {
        ...
        "validation_evaluator": validation_evaluators(dataset_reader, validation_iterator)[name]
}