...
local my_prefix = "data/";
{
    ...
    "train_data" : {
        "DM" : "/proj/irtg/sempardata/ACL2019/SemEval/2015/DM/train/train_small.amconll", 
#        "DM" : my_prefix+"DM/output/train/train.amconll",
    ...
    "gold_dev_data" : { #gold AM dependency trees for (a subset of) the dev data
        "DM" : "/proj/irtg/sempardata/ACL2019/SemEval/2015/DM/gold-dev/gold-dev.amconll",
