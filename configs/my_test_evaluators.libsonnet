...
local data_paths = import 'my_data_paths.libsonnet';
...
local SDP_evaluator(dataset_reader, data_iterator, name, threads) = [
        [name+"_id", { #prefix used for evaluation metric
            ...
            "formalism" : name,
            "system_input" : my_sdp_prefix+name+"/test.id/test.id.amconll",
            "gold_file": my_sdp_prefix+name+"/test.id/en.id."+std.asciiLower(name)+".sdp",
            "predictor" : {
...
function (dataset_reader, data_iterator) {
  "AMR-2015" :  [ ["AMR-2015",{ #prefix used for evaluation metric
        "type": "standard_evaluator",
        "formalism" : "AMR-2015",
        "system_input" : my_prefix+"AMR/2015/test/test.amconll",
        "gold_file": my_prefix+"AMR/2015/test/goldAMR.txt",
        "predictor" : {
                "type" : "amconll_predictor",
                "dataset_reader" : dataset_reader,
                "data_iterator" : data_iterator,
    ...
    "AMR-2017" :  [ ["AMR-2017",{ #prefix used for evaluation metric
        "type": "standard_evaluator",
        "formalism" : "AMR-2017",
        "system_input" : my_prefix+"AMR/2017/test/test.amconll",
        "gold_file": my_prefix+"AMR/2017/test/goldAMR.txt",
        "predictor" : {
                "type" : "amconll_predictor",
                "dataset_reader" : dataset_reader,
                "data_iterator" : data_iterator,
    ...
    "EDS" :  [
        ...
        "type": "standard_evaluator",
        "formalism" : "EDS",
        "system_input" : my_prefix+"EDS/test/test.amconll",
        "gold_file": my_prefix+"EDS/test/test-gold",
        "use_from_epoch" : 1,
        "predictor" : {
                "type" : "amconll_predictor",
                "dataset_reader" : dataset_reader, #same dataset_reader as above.
