...
ln -s "$SCRIPTPATH/../dev/goldAMR.txt" "$dir/goldAMR.txt"
ln -s "$SCRIPTPATH/../dev/literal.txt" "$dir/literal.txt"
ln -s "$SCRIPTPATH/../dev/sentences.txt" "$dir/sentences.txt"
ln -s "$SCRIPTPATH/../dev/pos.txt" "$dir/pos.txt"
