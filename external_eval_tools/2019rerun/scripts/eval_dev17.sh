...
ln -s "$SCRIPTPATH/../dev17/goldAMR.txt" "$dir/goldAMR.txt"
ln -s "$SCRIPTPATH/../dev17/literal.txt" "$dir/literal.txt"
ln -s "$SCRIPTPATH/../dev17/sentences.txt" "$dir/sentences.txt"
ln -s "$SCRIPTPATH/../dev17/pos.txt" "$dir/pos.txt"
